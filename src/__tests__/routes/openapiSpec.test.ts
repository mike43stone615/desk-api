...
const NOT_OPERATIONS = /^GET (\/|\/login|\/developer|\/app\.js|\/style\.css|\/desk_logo\.png|\/fonts\/.*|\/pages\/.*|\/docs|\/docs\/openapi\.json|\/gateway\/openapi\.json)$|\/gateway\/(registry|market)\/\*$|\{\*\}/;
