...
const NOT_OPERATIONS = /^GET (\/|\/login|\/developer|\/developer\/teams|\/developer\/webhooks|\/developer\/apps|\/developer\/billing|\/developer\/admin|\/tabs\.js|\/format\.js|\/developer\/authorize|\/team-rules\.js|\/confirm-email|\/reset-password|\/app\.js|\/style\.css|\/desk_logo\.png|\/fonts\/.*|\/pages\/.*|\/docs|\/docs\/openapi\.json|\/gateway\/openapi\.json)$|\/gateway\/(registry|market)\/\*$|\{\*\}/;
