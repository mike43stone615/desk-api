...
// src/openapi.ts. Not exhaustive for every proxy/integration route (those
// are thin pass-throughs to compliance-os/registry-api/market-validation-api,
// which each publish their own spec) — covers this service's own surface:
// auth, business setup, and the admin table browser.
