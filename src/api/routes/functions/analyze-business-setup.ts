        ...
        messages: [
          {
            ...
            content:
              ...
              "targetMarket must name a specific customer segment by role, need, or occasion — never just a location. Bad: \"residents and businesses in Denver, CO\". Good: \"Local commuters, students, and remote workers who want a fast coffee order on the way to work or class\", \"Small landlords managing 1-10 rental units who need bookkeeping without hiring full-time staff\", \"Local residents and members eligible to join who want member-owned banking with lower fees than a national bank\". Ground it in what this specific business actually does and who specifically needs that, not a generic \"residents and businesses\" phrase that could describe any business in any city. " +
